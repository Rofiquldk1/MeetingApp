...
public class RSAUtil {
    ...
    public static PublicKey getPublicKey(String base64PublicKey){
        ...
        try{
            X509EncodedKeySpec keySpec = new X509EncodedKeySpec(Base64.decode(base64PublicKey.getBytes("UTF-16"),Base64.DEFAULT));
    ...
    public static PrivateKey getPrivateKey(String base64PrivateKey) throws UnsupportedEncodingException {
        ...
        PKCS8EncodedKeySpec keySpec = new PKCS8EncodedKeySpec(Base64.decode(base64PrivateKey.getBytes("UTF-16"),Base64.DEFAULT));
    ...
    public static String decrypt(String data, String base64PrivateKey) throws IllegalBlockSizeException, InvalidKeyException, BadPaddingException, NoSuchAlgorithmException, NoSuchPaddingException, UnsupportedEncodingException {
        return decrypt(Base64.decode(data.getBytes("UTF-16"), getPrivateKey(base64PrivateKey));
    }
